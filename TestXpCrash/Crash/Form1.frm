...
Begin VB.Form Form1 
   ...
   Begin CrashXP.UserControl1 UserControl11 
      Height          =   495
      Left            =   240
      TabIndex        =   3
      Top             =   1260
...
' DateTime  : 12/20/2007
' Author    : Dracull
' Purpose   : Demonstration of XP theme crash in compiled exe
'---------------------------------------------------------------------------------------
...
Private Sub Form_Load()
 Check1.Value = 1
 Check1.Caption = "Usercontrol will cause crash!"
 ...
 Label1 = "Crash happens at offset 0x773e65e1 when closing an app using xp theme." & _
  ...
  vbCrLf & "The method for enabling xp theme consists of a single call to 'InitCommonControls' in the Form_Initialize()." & _
